...
/**
 * Represents a native ended event.
 *
...
public class EndedEvent extends DomEvent<EndedHandler> {
  ...
  /**
   * Event type for ended events. Represents the meta-data associated with this
   * event.
   */
  private static final Type<EndedHandler> TYPE = new Type<EndedHandler>(
      "ended", new EndedEvent());

  /**
   * Gets the event type associated with ended events.
   * 
