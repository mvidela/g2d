...
/**
 * Represents a native timeupdate event.
 *
...
public class TimeUpdateEvent extends DomEvent<TimeUpdateHandler> {
  ...
  /**
   * Event type for timeupdate events. Represents the meta-data associated with this
   * event.
   */
  ...
  /**
   * Gets the event type associated with timeupdate events.
   * 
