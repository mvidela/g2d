...
public class LoadedMetadataEvent extends DomEvent<LoadedMetadataHandler> {
  ...
  /**
   * Event type for loadedmetadata events. Represents the meta-data associated with this
   * event.
   */
  private static final Type<LoadedMetadataHandler> TYPE = new Type<LoadedMetadataHandler>(
      "loadedmetadata", new LoadedMetadataEvent());

  /**
   * Gets the event type associated with loadedmetadata events.
   * 
