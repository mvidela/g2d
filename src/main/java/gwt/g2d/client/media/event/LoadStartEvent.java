...
public class LoadStartEvent extends DomEvent<LoadStartHandler> {
  ...
  /**
   * Event type for loadstart events. Represents the meta-data associated with this
   * event.
   */
  private static final Type<LoadStartHandler> TYPE = new Type<LoadStartHandler>(
      "loadstart", new LoadStartEvent());
