...
/**
 * Multiply the current canvas' transformation by this transformation.
 * 
...
public class TransformVisitor implements ShapeVisitor {
	 ...
	 * @param dy
	 */
	public TransformVisitor(double m11, double m12, double m21, double m22,
      double dx, double dy) {
		this.m11 = m11;
		this.m12 = m12;
		this.m21 = m21;
	 ...
	 * @param matrix
	 */
	public TransformVisitor(Matrix matrix) {
	...
	public void visit(Surface surface) {
		surface.getContext().transform(m11, m12, m21, m22, dx, dy);
	}
}
